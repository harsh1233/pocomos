...
class CustomerRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'billing_information.routing_number' => 'nullable|max:20',
            ...
            'agreement.autopay_signature' => 'nullable|mimes:png,jpg,jpeg',
