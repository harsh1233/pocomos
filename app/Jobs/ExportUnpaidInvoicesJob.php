...
class ExportUnpaidInvoicesJob implements ShouldQueue
{
    use Dispatchable;
    ...
    public function handle()
    {
        ...
        $alert_details['name'] = 'Unpaid invoice Export';
        $alert_details['description'] = 'The Unpaid invoice export has completed successfully<br><br>
                            <a href="'.env('APP_URL').'/download/unpaid-invoice-export/'.$encode.'">Download  Unpaid invoice Export </a>';
